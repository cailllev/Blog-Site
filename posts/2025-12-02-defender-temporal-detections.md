...
<cap>First run of LsassReader-deconditioning.exe is successful.</cap>

![LsassReader standard works](/static/defender-temporal-detections/LsassReader-standard-works.png)
<cap>Now the LsassReader-standard.exe also does not raise behavioural alerts.</cap>
...
![LsassReader standard detected](/static/defender-temporal-detections/LsassReader-standard-detected.png)
<cap>After a triggered alert, the temporal behavioral detections are reset for LsassReader-(x).exe.</cap>
...
<p><i>Correction: "Metadata is sent for detections even when sample submission is disabled", see [here](https://learn.microsoft.com/en-us/defender-endpoint/cloud-protection-microsoft-antivirus-sample-submission#:~:text=Do%20not%20send) </i>
