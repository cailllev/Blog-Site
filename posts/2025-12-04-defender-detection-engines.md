...
Defender (and any modern EDR) has 4 different analysis engines, i.e. different mechanisms to catch your malware: <b>Signature, Sandbox, Memory, Behaviour</b>
...
## My Observations
Below is my theory how Defender (or any modern EDR) catches your malware. A red "m" means the executable is detected.<br><br>

![Defender Scanning Engines](/static/defender-detection-engines/defender-scanning-engines.png)
<cap>Defender's Scanning Engines</cap>
